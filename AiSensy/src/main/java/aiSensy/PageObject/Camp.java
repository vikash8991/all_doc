...
//	@FindBy(xpath = "//span[text()=\"Next\"]")
	...
	//By btnNextAfterSelectingTemplates=By.xpath("//span[text()=\\\"Next\\\"]");
	...
	//By btnNextAfterSelectingTemplates1=By.xpath("//span[text()=\\\"Next\\\"]");
...
//	By btn_login=By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div[2]/div/div/div/div/button/span[1]/h5");
...
//		
//		
//		WebElement clickOnNext = driver.findElement(btn_nextAfterFilter);
//		clickOnNext.click();
    ...
    public void clickNextAfterSelectingTemplate() throws InterruptedException {
    	//btnNextAfterSelectingTemplates.click();
//    	
//    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
//        
//        try {
...
//    	btnNextAfterSelectingTemplates1.click();
