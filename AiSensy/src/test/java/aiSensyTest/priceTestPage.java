...
//        Camp campaignPage = new Camp(driver);
//        campaignPage.campCreation();
...
//    }
    ...
    void marketingCharges() throws InterruptedException {
        ...
        try {
            ...
            System.out.println("AiSensy Marketing Charges: ₹ " + String.format("%.2f", result));
