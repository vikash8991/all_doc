...
//By.xpath("//input[@id='companyDescription']")
//By.xpath("//input[@id='mui-88739']")
//By.xpath("//input[@id='mui-59204']")
//By.xpath("//input[@id='mui-26624']")
//By.xpath("//input[@id='mui-26624']")
//By.xpath("//input[@id='mui-23847']")
...
//	@FindBy(id="mui-2039") 
//	WebElement StaticDropDown_country;
...
//		StaticDropDown_country.sendKeys(country);
//		
//	}
	
//	public void selectCountry(String country) {
//		Select countrySelect = new Select(StaticDropDown_country);
//		countrySelect.selectByVisibleText("country"); // or use selectByValue() or selectByIndex()
//	}
